...
<html lang="en">
<head>
  <title>Friend System | Signup</title>
  <meta charset="utf-8">
...
<div class="row justify-content-center" style="padding-top: 200px;">
  <div class="col-sm-4">
     <div class="card">
    <div class="card-header"><h3> Singup</h3></div>
   ...
   <form action="signup_auth.php" method="POST">
    ...
    <input type="submit" name="signup" class="btn btn-primary" value="Signup" class="form-control"> <span> Don't have an account? <a class="text-danger" href="index.php">Login</a></span>
    </div>
